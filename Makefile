...
deploy:
	make build
	sam deploy --no-fail-on-empty-changeset --no-confirm-changeset  --capabilities CAPABILITY_NAMED_IAM --region eu-west-1 --profile personal --stack-name web-observer-test --template-file ./deployment/observer.yml
